...
public class IndexDataService {
    ...
    public List<RankedIndexPerformanceDto> getRankedPerformance(Long indexInfoId, PeriodType periodType, int limit) {
        ...
        LocalDate start = calculateDate(now, periodType);
        LocalDate end = now;
        ...
        for (Map.Entry<Long, IndexData> e : latestById.entrySet()) {
            ...
            if (past == null || cur.getBaseDate().equals(past.getBaseDate()) || past.getClosingPrice() == null) {
                beforePrice = curPrice;
            } else {
                beforePrice = past.getClosingPrice();
            }
